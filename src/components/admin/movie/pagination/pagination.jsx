...
import { increasePageMovie, decreasePageMovie,setPageMovie } from '../../../../redux/adminSlice'

function PaginationMovie(props) {
    const dispatch = useDispatch()
    const pagination = useSelector(state => state.admin.movies.paginationMovie)
    const totalPages = Math.ceil(pagination.total/LIMIT_GIFT_ADMIN)

    function handleClickNextPage(){
        dispatch(increasePageMovie())
    }

    function handleClickPrePage(){
        dispatch(decreasePageMovie())
    }
